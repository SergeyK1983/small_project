...
class TestChangePWD:
    ...
    def test_change_user_password(self, mock_user, mock_change_pwd, client_with_user): 
    ...
    @patch("src.auth.utils.password.UserPasswordRepo.read_user_with_password")
    def test_change_password_none_user(self, mock_user, client_with_user):
        client, user_factory = client_with_user
    ...
    @patch("src.auth.utils.password.UserPasswordRepo.read_user_with_password")
    def test_change_password_invalid_form_data_pwd(self, mock_user, client_with_user, form_data, expected):
        client, user_factory = client_with_user
